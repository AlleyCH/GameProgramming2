...
public class ClassBasedFSM : MonoBehaviour
{
    ...
    public StateMachine.State walk, chase, attack, runAway, rest;
    ...
    void Start()
    {
        ...
        //StateMachine.State walk = new StateMachine.State();
        walk = stateMachine.CreateState("Walk");
        walk.onEnter = delegate { Debug.Log("Walk.onEnter"); };
        walk.onExit = delegate { Debug.Log("Walk.onExit"); };
        walk.onFrame = WalkOnFrame;
        ...
        rest = stateMachine.CreateState("Rest");
        rest.onEnter = delegate { Debug.Log("Rest.onEnter"); };
        rest.onExit = delegate { Debug.Log("Rest.onExit"); };
        rest.onFrame = RestOnFrame;


    }
    void WalkOnFrame()
    {
        Debug.Log("Walk.onFrame");
        //DEAFULT actions during Walk state
        //print("Walkling...");
        Walk();
